...
/**
 * The `Book` class represents a basic data structure for storing information
 * about books.
 * It encapsulates three main attributes of a book: its unique identifier
 * (`id`), title, and author.
...
class Book {
	 ...
	 * Initializes the `id`, `title`, and `author` attributes with the provided
	 * values.
	 *
	...
	/**
	 * Determines the status of the book if available or not.
	 *
	 ...
	 *
	 * @return A string containing book details in the format: "Book [id=<id>,
	 *         title=<title>, author=<author>]".
	 */
	@Override
	public String toString() {
		return String.format("Book [id=%d, availability=%s, title=%s, author=%s]", id,
				isAvailable ? "Available" : "Not Available", title, author);
	}
}